...
import br.senac.ti.Evox.dao.ConsultoriaDAO;
 ...
 * @author Senacrio
 */
@WebServlet(name = "ConsultoriaServlet", urlPatterns = {"/ConsultoriaServlet"})
public class ConsultoriaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Consultoria cad = new Consultoria();
            ...
            if(op .equals("Alterar")){
                cad.setId_consultoria(Integer.parseInt(request.getParameter("Bid")));
                cad.setNome(request.getParameter("txtNome"));
                cad.setDescricao(request.getParameter("txtDescricao"));
                resp = request.getParameter("status");
                if(resp .equals("S")){
            ...
            if(op .equals("Deletar")){
                ...
                resposta = dao.removerConsultoria(cad.getId_consultoria());
